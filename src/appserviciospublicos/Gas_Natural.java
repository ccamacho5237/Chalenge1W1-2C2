 ...
 */
public class Gas_Natural {
    private int estrato;
    private int consumo;
    private double Gas_Natural;
    ...
    public double getGas_Natural() {
        return Gas_Natural;
    }

    public void setGas_Natural(double Gas_Natural) {
    ...
    public double calcular_costo_total() {
        costo_total = (consumo * Gas_Natural);
        return costo_total;
    }
    ...
    public double valor_total_pagar() {
        if (estrato >= 1 && estrato <= 2) {
            Total = (consumo * Gas_Natural) - (consumo * Gas_Natural * 0.5) + (consumo * Gas_Natural * 0.01);
        } else if (estrato >= 3 && estrato <= 4) {
            Total = (consumo * Gas_Natural) - (consumo * Gas_Natural * 0.1) + (consumo * Gas_Natural * 0.01);
        } else if (estrato >= 5 && estrato <= 6) {
            Total = (consumo * Gas_Natural) + (consumo * Gas_Natural * 0.25) + (consumo * Gas_Natural * 0.01);
        } else {
